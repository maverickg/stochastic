...
For instance, if it was black jack, you can count the number of face cards in play and know whether the deck is ``hot'' or not.
If the outcome of the game is a martingale, then this extra information you have acquired \emph{can not} help you going forward. 
...
\begin{equation*}
  ...
  \defeq \E \paren[\big]{ \one_R \P( H \given \mathcal C ) }
  = \P( H \given R) \, \P(R) \,.
\end{equation*}
...
\begin{equation*}
  ...
  \quad\text{and}\quad
  \P( H \given B )
    = \frac{1}{\P(B)} \int_B \P( H \given \mathcal C ) \, d\P\,.
\end{equation*}
...
Let $X$ be the outcome of a game where you win $\$1$ if a high card is drawn and lose $\$1$ otherwise.
You play this game through a bookie, who pays you your winnings but only tells you the color of the card that is drawn, and not whether it is high or not.
...
Note that the events you can deduce information about by playing this game (through the bookie) are exactly elements of the $\sigma$-algebra $\mathcal C = \set{\emptyset, R, B, \Omega}$.
...
\textbf{2017-01-16: More will be added here later.}
