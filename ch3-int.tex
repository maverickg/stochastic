...
\begin{theorem}[It\^o formula]
  If $f = f(t, x)$ is $C^{1,2}$ (i.e.\ a function that is continuously differentiable in $t$ and twice continuously differentiable in $x$), then
...
\section{A few examples using It\^o's formula (unfinished)}
